...
Ierror <- safewrite.csv(Summary_Kenngrößen, filename = paste("01 - Projekte/",Projekt,"/",Charge,"/Ergebnisse/",Version,"/Partikelgröße/nach Klassen/",aktuelle.Klasse,"_Kenngrößen_",Version,".csv",sep=""),rownames = TRUE)
